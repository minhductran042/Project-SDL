...
int SDLBaseFunc::ShowMenu(SDL_Renderer* g_screen, TTF_Font* font,
...
int SDLBaseFunc::ShowMenuEnd(SDL_Renderer* g_screen, TTF_Font* font,
    const std::string& menu1,
    const std::string& img_name)
{
    char* ch1 = (char*)menu1.c_str();
...
bool SDLBaseFunc::CheckCrash(const SDL_Rect& object1, const SDL_Rect& object2)
{
